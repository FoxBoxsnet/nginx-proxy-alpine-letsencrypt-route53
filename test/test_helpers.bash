...
SUT_IMAGE=foxboxsnet/nginx-proxy-alpine-letsencrypt-route53:bats
...
# and displays the nginx-proxy-alpine-letsencrypt-route53 start logs
#
# $1 container name
...
# wait until the nginx-proxy-alpine-letsencrypt-route53 container is ready to operate
#
# $1 container name
