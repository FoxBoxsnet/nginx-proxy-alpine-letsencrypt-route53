...
@test "[$TEST_FILE] start a nginx-proxy-alpine-letsencrypt-route53 container" {
	# GIVEN nginx-proxy-alpine-letsencrypt-route53
...
@test "[$TEST_FILE] nginx-proxy-alpine-letsencrypt-route53 defaults to the service running on port 80" {
	# WHEN
...
# assert querying nginx-proxy-alpine-letsencrypt-route53 provides a response from the expected port of the web container
